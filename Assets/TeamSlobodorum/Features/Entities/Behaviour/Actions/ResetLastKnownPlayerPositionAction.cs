...
namespace TeamSlobodorum.Entities.Behaviour.Actions
{
    ...
    [NodeDescription(name: "Reset Last Known Player Position",
        story: "Reset the last known player position of [Brain]",
        category: "Action/Entity", id: "01f9a1c8f58b4dde8c56e41d38dd848f")]
    public partial class ResetLastKnownPlayerPositionAction : Action
    {
